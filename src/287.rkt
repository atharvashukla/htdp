...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 287ex) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Exercise 287
;; ------------
...
(define (eliminate-expensive lo-ir ua)
  (filter (λ (ir) (< (ir-sales-price ir) ua)) lo-ir))
...
(define (recall lo-ir ty)
  (filter (λ (ir) (not (string=? (ir-name ir) ty))) lo-ir))
