...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 440ex) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Exercise 440
;; ------------
