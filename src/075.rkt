...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 75ex) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Exercise 75.
;; ------------
...
;; “making a wish” (part of the "wish  list")
