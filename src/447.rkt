...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 447ex) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Exercise 447
;; ------------
...
(check-satisfied (find-root poly -10 10) (check-root poly))
