...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 277ex) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Exercise 277
;; ------------
;; 
...
(define (any-missile-hit? ufo lom)
  (ormap (λ (x) (missile-hit? ufo x)) lom))
