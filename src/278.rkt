...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 278ex) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Exercise 278
;; ------------
...
;; ISL. Look for places to use them and replace existing code, a piece at a
...
(define (render-snake-body s)
  (foldr render-snake-part BACKG s))
